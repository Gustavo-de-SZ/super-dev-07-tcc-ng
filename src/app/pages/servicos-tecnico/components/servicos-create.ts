...
@Component({
        ...
        <form>
          <div class="tcc-form-row">
            <div class="tcc-form-group flex-2">
              <label class="tcc-form-label">Título do Serviço</label>
              <input type="text" class="tcc-input" placeholder="Ex: Formatação e Reinstalação do Windows">
            </div>
            <div class="tcc-form-group flex-2">
              <label class="tcc-form-label">Cliente vinculado</label>
              <select class="tcc-input" [(ngModel)]="selectedClienteNome">
                <option value="" disabled selected>Selecione um cliente...</option>
                <option *ngFor="let cliente of clientes" [value]="cliente.nome">
          ...
          <div class="tcc-form-row">
            <div class="tcc-form-group">
              <label class="tcc-form-label">Categoria (Ícone)</label>
              <select class="tcc-input">
                <option value="pi-desktop">Manutenção (Desktop)</option>
                <option value="pi-wifi">Redes (Wi-Fi)</option>
                <option value="pi-database">Hardware (HD/SSD)</option>
                <option value="pi-shield">Segurança (Antivírus)</option>
              </select>
            </div>
            <div class="tcc-form-group">
              <label class="tcc-form-label">Data de Execução</label>
              <input type="date" class="tcc-input">
            </div>
            <div class="tcc-form-group">
              <label class="tcc-form-label">Valor (R$)</label>
              <input type="number" step="0.01" class="tcc-input" placeholder="0,00">
            </div>
          </div>

          <div class="tcc-form-row">
            <div class="tcc-form-group">
              <label class="tcc-form-label">Status do Serviço</label>
              <select class="tcc-input">
            ...
            <div class="tcc-form-group">
              <label class="tcc-form-label">Tempo Gasto</label>
              <input type="text" class="tcc-input" placeholder="Ex: 3h">
            </div>
          </div>

          <div class="tcc-form-row">
            <div class="tcc-form-group">
              <label class="tcc-form-label">Descrição Técnica do Serviço</label>
              <textarea class="tcc-textarea" placeholder="Descreva o que foi feito no equipamento..."></textarea>
            </div>
          </div>

          <div class="tcc-form-actions">
            <button type="button" class="tcc-btn-cancel" (click)="cancelar()">Cancelar</button>
            <button type="submit" class="tcc-btn-main" (click)="salvar()">Cadastrar Serviço</button>
          </div>
        </form>
      </div>
  ...
  `,
  styles: [`
    /* Reaproveitamento exato do Design System criado no Novo Agendamento */
...
export class NovoServico {
  ...
  cancelar(): void {
    console.log('Cancelar serviço');
  }

  salvar(): void {
    console.log('Salvar serviço com cliente:', this.selectedClienteNome);
    // TODO: Implementar chamada para ServicoService.create()
  }
}